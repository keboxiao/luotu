...
<%
            ...
            int length = -1;
            File f2=new File("D:/download/importBaseStation.xls");          
            ...
            response.setHeader("Content-disposition", "attachment; filename="+new String("importBaseStation.xls".getBytes("gb2312"),"iso8859-1"));
